    ...
    <footer className="mt-16 rounded-2xl bg-dark dark:bg-accentDark/90 m-2 sm:m-10 flex flex-col items-center text-light dark:text-dark">
      ...
      >
        <input
          ...
          className="w-full bg-transparent pl-2 sm:pl-0 text-dark dark:text-light/50 focus:border-dark dark:focus:border-light/50 focus:ring-0 border-0 border-b mr-2 pb-1"
        />
